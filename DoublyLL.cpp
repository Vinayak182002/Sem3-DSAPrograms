...
void DoublyLL::insertAtPos(int position)
{
	struct node* new_node=new node();
	cout<<"\n=================You are doing Insertion Operation at Position====================";
	cout<<"\nEnter the number to be stored in the Linked List:";
